...
var avgChange = 0;
var greatestInc = 0;
var greatestIncDate = 0;
var greatestDec = 0;
var greatestDecDate = 0;
...
for (var i = 0; i < totalMonths-1 ; i++) {
   ...
   var avgChangeRound = Math.round(avgChange * 100)/ 100;

   if (greatestInc < change) {
      greatestInc = change;
      greatestIncDate = finances [i+1][0];
   } 
   
   else if (greatestDec > change){
      greatestDec = change;
      greatestDecDate = finances[i+1][0];
   }

}

// The greatest increase in profits(date and amount) over the entire period.
// var greatestDecSum = finances[i] => finances[i].reduce; 
// greatestDecSum = greatestDecSum/ totalMonths;
// console.log(greatestDecSum)
console.log("Financial Analysis")
console.log("----------------------------");
console.log ("Total Months: ", totalMonths);
console.log ("Total: $" + totalProfLoss);
console.log("Average Change: $" + avgChangeRound);
console.log("Greatest Increase in Profits:" , greatestIncDate, "$" + greatestInc);
console.log("Greatest Decrease in Profits:" , greatestDecDate, "$" + greatestDec);
